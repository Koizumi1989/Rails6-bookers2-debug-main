class Book < ApplicationRecord
  ...
  scope :created_2day, -> { where(created_at: 2.day.ago.all_day) } # 2日前
  scope :created_3day, -> { where(created_at: 3.day.ago.all_day) } # 3日前
  scope :created_4day, -> { where(created_at: 4.day.ago.all_day) } # 4日前
  scope :created_5day, -> { where(created_at: 5.day.ago.all_day) } # 5日前
  scope :created_6day, -> { where(created_at: 6.day.ago.all_day) } # 6日前
